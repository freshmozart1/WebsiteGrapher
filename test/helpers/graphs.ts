  ...
  return {
    ...
    pages: [
      ...
      },
      {
        ...
        components: ["comp-list", "comp-filter-category", "comp-pagination"],
        stateDimensions: [
          {
            id: "dim-category",
            kind: "filter",
    ...
    fields: [
      ...
      field("field-price", "price", { css: ".product_main .price_color" }, "currency"),
      field("field-description", "description", { css: "#product_description ~ p" }),
      field("field-image", "image", { css: "#product_gallery img" }, "url"),
      field("field-star-rating", "star-rating", { css: ".product_main .star-rating" }),
      field("field-availability", "availability", { css: ".product_main .availability" }),
    ],
    goals: [
      {
        id: "goal-find-price",
